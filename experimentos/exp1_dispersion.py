...
N = 100
Ds = np.array(range(50, 3051, 50)) #Dispersión
cs = []

for D in Ds:
	#gra = grafoRandomUniforme(N, (1000-D, 1000+D)) #grafo de tamaño 100
	gra = grafoRandomUniforme(N, (1, D)) #grafo de tamaño 100
	#gra = grafoRandomEuclideo(N, D) #grafo de tamaño 100
...
plt.ylabel("Costo total/$n$")
plt.xlabel("Tamaño de intervalo ($n_f$)")
plt.legend(title='Costo de la solución hallada')
plt.savefig('costo_dispersion.pdf')