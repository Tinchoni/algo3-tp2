...
inp_ari = "--algoritmo Tabu --solInicial AGM --itParada 50 --tipoMemoria aristas --tamanioMemoria %i -d 30"
out_ari = dict()
inp_sol = "--algoritmo Tabu --solInicial AGM --itParada 50 --tipoMemoria soluciones --tamanioMemoria %i -d 30"
out_sol = dict()

grafos = ["gr48", "gr202"]#,"gr21","gr96","gr431"]
memorias = list(range(1, 71, 10))
